        ...
        try {
            ...
            if (table.equals("请选择")) {
                ...
                if (data.length() == 0) {
                    switch (table) {
                        case "用户信息":
                            s = selectUser(connection.prepareStatement("select * from users"), new StringBuilder("<p><h6>id&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;用户名&emsp;&emsp;&emsp;&emsp;&emsp;密码&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;生日&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;身份证号&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;账户类型</h6></p>"));
                            break;
                        case "考试信息":
