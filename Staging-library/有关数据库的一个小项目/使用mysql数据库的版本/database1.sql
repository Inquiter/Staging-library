...
create table user(id int(100) auto_increment primary key,username varchar(100),password varchar(100),birthday datetime,idcard varchar(20),account_type varchar(1)) character set utf8;
select * from user;

insert into user values(1,'张三','123','2000-1-1 00:00:00','111111111111111111','0');
insert into user values(2,'李四','456','2000-1-1 00:00:00','111111111111111111','1');
drop table user;

create table examination(id int(100) auto_increment primary key,examination_subjects varchar(100),examination_introduction varchar(1000),examination_information varchar(1000),examination_requirements varchar(1000),examination_content varchar(1000),examination_time datetime,examination_place varchar(100)) character set utf8;
select * from examination;

insert into examination values(1,'普通话一级考试',
...
'2022-12-20 08:00:00',
'1号楼1209');
insert into examination values(2,'普通话二级考试',
...
create table roll(id int(100) auto_increment primary key,username varchar(100),idcard varchar(20),registration_time datetime,examination_subjects varchar(100),examination_time datetime,examination_place varchar(100),examination_fee varchar(100),payment_method varchar(100),payment_status varchar(100)) auto_increment=1 character set utf8;
select * from roll;
